...
**См. также:** Cure Poison переиспользует `PoisonWave.shader` — [2026-06-04-cure-poison-composite.md](./2026-06-04-cure-poison-composite.md) (не менять default properties шейдера).
