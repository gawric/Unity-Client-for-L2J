...
public class FilterAccessType
{
    private static readonly Dictionary<GameInterludeServerPacketType, bool> GamePacketTypes = new Dictionary<GameInterludeServerPacketType, bool>
    {
        ...
        { GameInterludeServerPacketType.JoinParty, true },
        { GameInterludeServerPacketType.PartySmallWindowAll, true },
        { GameInterludeServerPacketType.PartySmallWindowAdd, true },
        { GameInterludeServerPacketType.PartySmallWindowUpdate, true },
        { GameInterludeServerPacketType.PartySmallWindowDelete, true },
        { GameInterludeServerPacketType.PartySmallWindowDeleteAll, true },
        { GameInterludeServerPacketType.PartySpelled, true },
