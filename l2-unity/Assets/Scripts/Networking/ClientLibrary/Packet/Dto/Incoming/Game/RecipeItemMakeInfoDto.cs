...
public class RecipeItemMakeInfoDto : IWireDto
{
    ...
    public void ReadFrom(PacketReader reader)
    {
        try
        {
            ...
            _recipeId = reader.ReadI();
            _isDwarven = reader.ReadI();
            _currentMp = reader.ReadI();
            _maxMp = reader.ReadI();
            _status = reader.ReadI();
