// e_u031_a SpriteEmitter2 "upline": fx_m_t0059, polar spawn, flipbook 2x2, acceleration up.
// TODO: port full sprite emitter shader.
Shader "L2/Effects/TeleportCaSpriteUpline"
{
    Properties
    {
        _MainTex ("Texture (fx_m_t0059)", 2D) = "white" {}
        _Tint ("Debug Tint", Color) = (0.6, 0.6, 0.8, 0.5)
    }
