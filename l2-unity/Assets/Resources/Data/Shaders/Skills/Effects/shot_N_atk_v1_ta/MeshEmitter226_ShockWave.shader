// shot_N_atk_v1_ta / MeshEmitter226 "ShockWave"
// UC: shockwave00, UseMeshBlendMode=False, RenderTwoSided, SpinParticles,
//   SizeScale grow, FadeOut only (0.0375), Opacity=0.6, ColorScale×2 white,
//   ColorMul (0.8,0.8,0.7), StartSize (0.1, 0.14, 0.14), Life=0.2,
//   StartVelocity X=4, StartSpin Z only [0,1], no SPS / no Offset / no PTRS.
// Warmup: RelativeWarmupTime=0.05 → ParticleGroup ~0.01s (0.05*life).
...
Shader "L2/Effects/shot_N_atk_v1_ta/MeshEmitter226_ShockWave"
{
    Properties
    {
        ...
        _LifetimeRange ("Lifetime Min Max", Vector) = (0.2, 0.2, 0, 0)
        [Toggle] _UseManualAge ("Use Manual Age", Float) = 0
        _ManualAge ("Manual Age sec", Range(0, 0.2)) = 0
        ...
        _StartSizeRangeXUc ("StartSize X Min Max", Vector) = (0.1, 0.1, 0, 0)
        _StartSizeRangeYUc ("StartSize Y Min Max", Vector) = (0.14, 0.14, 0, 0)
        _StartSizeRangeZUc ("StartSize Z Min Max", Vector) = (0.14, 0.14, 0, 0)
        _MeshSpawnRandStateBits ("appRand TLS before StartVelocity (uint bits)", Float) = 0

        [Toggle] _UseSizeScale ("Use SizeScale", Float) = 1
        _SizeKey0 ("SizeScale 0 Time Size", Vector) = (0.09, 2, 0, 0)
        _SizeKey1 ("SizeScale 1 Time Size", Vector) = (0.23, 2.5, 0, 0)
        _SizeKey2 ("SizeScale 2 Time Size", Vector) = (0.52, 3, 0, 0)
        ...
        _ColorMultiplier ("ColorMultiplier RGB", Vector) = (0.8, 0.8, 0.7, 0)
