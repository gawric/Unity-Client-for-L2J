// it_healing_potion_ta / MeshEmitter0 "Wave"
// UC: SpinParticles, SizeScale (non-uniform Z), Opacity=0.5, FadeIn/Out, StartVelocity Z, PTDS_Brighten
//
// Spawn Loc/Vel/Size: L2FxMeshSpawnParticle (TLS appRand; ranges from this mat).
//   This effect is the only verified caller so far (Name="Wave" / it_healing_potion_ta).
// Size + spin use Decompile_Common only:
//   S: FinalSize UE (XY,XY,Z) applied as Unity (XY,Z,XY) on remapped mesh
//   R: L2FxMeshSpin FRotator (Pitch,Yaw,Roll)=(c1,c0,c2)
// Do not route Wave through L2FxPTRS_Actor (that is UseRotationFrom=PTRS_Actor).
Shader "L2/Effects/it_healing_potion_ta/MeshEmitter0_Wave"
{
    Properties
    {
