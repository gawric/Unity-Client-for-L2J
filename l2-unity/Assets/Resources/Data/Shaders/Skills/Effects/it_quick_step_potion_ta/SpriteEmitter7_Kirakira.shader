// it_quick_step_potion_ta / SpriteEmitter7 "kirakira"
// Same skeleton as healing kirakira; UC differs in ColorMul/size/lifetime/count.
// UC: Polar, Spin, SizeScale, ColorScale+Repeats, Flipbook RandomSubdivision 6..8,
//     PTVD_OwnerAndStartPosition, PTDS_Brighten
Shader "L2/Effects/it_quick_step_potion_ta/SpriteEmitter7_Kirakira"
{
    Properties
    {
